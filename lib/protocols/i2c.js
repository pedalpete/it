...
module.exports = function() {
	...
	if (!fvr.getI2cBus === undefined) {
		return fvr.onError(this, 'i2c bus address must be specified');
	}
	if (!_fvr.i2c) {
		_fvr.i2c = I2C.openSync(fvr.getI2cBus());
	}
	...
	if (!_fvr[fvr._index].init || _fvr[fvr._index].initialized) {
		...
		// if this initialize was called but not needed, return the callback
		if (!fvr._method) return fvr._callback.call(fvr, null);

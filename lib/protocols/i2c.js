...
function i2c(i2cCmd, cb) {
	var fvr = this;
	if(fvr._component.interface !== 'i2c') console.log('is i2c? ',this._component);
...
module.exports = function() {
	...
	if (!_fvr[fvr._index].init || _fvr[fvr._index].initialized) {
		...
		return componentUtils.runMethod.call(fvr, i2c);
	}
	// if this device has not been initialized, initialize then run the required method
	componentUtils.runMethod.call(fvr, i2c, 'init');
};
var i2c = require('os').arch() === 'arm' ?
	require('i2c') :
	require('../../tests/mocks/i2c.js');
...
function returnCallback(i2cVal) {
	var fvr = this;
	if (_fvr[fvr._index].postAction) {
		return fvr._callback.call(fvr, _fvr[fvr._index].postAction.call(fvr, i2cVal));
	}
...
module.exports = function() {
	...
	if (!_fvr[fvr._index].i2c) {
		 _fvr[fvr._index].i2c = new i2c(_fvr[fvr._index].address,{device: path, debug: false});
	}

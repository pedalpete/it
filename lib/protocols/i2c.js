...
function i2c(i2cCmd, callback) {
	...
	_fvr[this._index].i2c[getI2Ccmd(i2cCmd)](i2cCmd.addr, newVal,
		function(err, i2cVal) {
			if (err) fvr.err;
			if (i2cCmd.wait) {
...
module.exports = function() {
	...
	var path = _fvr[fvr._index].i2cPath || _fvr.i2cPath;

	if (!_fvr[fvr._index].i2c) {
		_fvr[fvr._index].i2c = I2C.openSync(_fvr[fvr._index].address);
	}

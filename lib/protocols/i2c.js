...
function getValueToSet(i2cCmd) {
	if (i2cCmd.formatInput) {
		return newVal = i2cCmd.formatInput.call(this, this._valueToSet);
	}
	if (this._valueToSet) return this._valueToSet;
	if (i2cCmd.cmd) return i2cCmd.cmd;
	return null;
}
...
function i2c(i2cCmd, callback) {
	...
	if (i2cCmd.type === 'read') return _fvr.i2c.readI2cBlock(address, i2cCmd.addr, i2cCallback);
	
	var newVal = getValueToSet.call(this, i2cCmd);
	_fvr.i2c.writeI2cBlock(i2cCmd.addr, i2cCmd.cmd, newVal.length, newVal, i2cCallback);
}

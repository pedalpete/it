...
function initializeI2C(val, cb){
    if(!_fvr[this._index].address) return this.onError("i2c bus address must be specified");
    var path = _fvr[this._index].i2c_path || _fvr.i2c_path || '/dev/i2c-1';
    if(!_fvr[this._index].i2c) _fvr[this._index].i2c= new i2c(_fvr[this._index].address, path);

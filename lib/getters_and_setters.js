...
function initializeI2C(val, cb){
    if(!_fvr[this._index].i2c_address) _fvr[this._index].i2c_address = this.i2c_address;
    if(!_fvr[this._index].i2c_address) return this.onError("i2c bus address must be specified");
    if(!_fvr.i2c) _fvr.i2c={};
    if(!_fvr.i2c[_fvr[this._index].i2c_address]) _fvr.i2c[_fvr[this._index].i2c_address]= new i2c(_fvr[this._index].i2c_address, _fvr[this._index].i2c_path || this.i2c_path);
...
function I2C(val, cb){
    ...
    if(!cmp.bytes) return _fvr.i2c[_fvr[this._index].i2c_address][i2ccmd(cmp)](cmp.byte, function(err,i2cVal){
        if(err) fvr.err;
    ...
    _fvr.i2c[_fvr[this._index].i2c_address][i2ccmd(cmp)](cmp.byte, newVal, function(err,i2cVal){
        if(err) fvr.err;

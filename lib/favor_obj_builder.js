    ...
    try {
        favor_obj = (function(){
            ...
            function setGpioDefaultValue(pin, component){
                ...
                fs.writeFileSync(favor_json.getGpioPath()+pin+'/value', value);
            }
            function setGpioDirection(pin, component){
                ...
                fs.writeFileSync(favor_json.getGpioPath()+pin+'/direction', direction);
            }
            function exportGpio(pin,component){
                //export the pin and prep the gpio
                fs.writeFileSync(favor_json.getGpioPath()+'/export', pin);
